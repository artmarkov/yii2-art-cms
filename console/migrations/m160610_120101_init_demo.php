...
class m160610_120101_init_demo extends Migration
{
    public function up()
    {
        ...
        $this->insert('{{%seo}}', ['url' => '/en', 'title' => 'Homepage', 'author' => 'Site Owner', 'keywords' => 'yii2, cms, artcms', 'description' => 'Seo meta description', 'index' => 1, 'follow' => 1, 'created_by' => 1, 'updated_by' => 1, 'created_at' => '1452544164', 'updated_at' => '1452545049']);
