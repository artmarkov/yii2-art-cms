...
class m160610_120101_init_demo extends Migration
{
    public function up()
    {
        ...
        $this->insert('{{%page}}', ['id' => '1', 'slug' => 'test', 'created_by' => 1, 'updated_by' => 1, 'status' => 1, 'comment_status' => 0,
            'published_at' => '1440720000', 'created_at' =>  time(), 'updated_at' =>  time()]);
        ...
        $this->insert('{{%post_category}}', ['id' => '2', 'slug' => 'first-category', 'created_by' => 1, 'updated_by' => 1, 'visible' => 1, 'sortOrder' => 1, 'created_at' => time(), 'updated_at' => time()]);
        $this->insert('{{%post_category_lang}}', ['post_category_id' => '1', 'title' => 'First Category', 'language' => 'en-US']);

        $this->insert('{{%post_tag}}', ['id' => '1', 'slug' => 'art-cms', 'created_by' => 1, 'updated_by' => 1, 'created_at' => time(), 'updated_at' => time()]);
        $this->insert('{{%post_tag}}', ['id' => '2', 'slug' => 'yii2', 'created_by' => 1, 'updated_by' => 1, 'created_at' => time(), 'updated_at' => time()]);

        $this->insert('{{%post_tag_lang}}', ['post_tag_id' => '1', 'title' => 'ArtCMS', 'language' => 'en-US']);
        ...
        $this->insert('{{%seo}}', ['url' => '/en', 'title' => 'Homepage', 'author' => 'Site Owner', 'keywords' => 'yii2, cms, artcms', 'description' => 'Seo meta description', 'index' => 1, 'follow' => 1, 'created_by' => 1, 'updated_by' => 1, 'created_at' =>  time(), 'updated_at' =>  time()]);
